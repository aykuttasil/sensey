...
public class TouchTypeDetectorTest {
  ...
  public void detectOnDoubleTap() {
    testTouchTypeDetector.getGestureListener().onDoubleTap(null);
    verify(mockListener, only()).onDoubleTap();
  }

  @Test
  public void detectOnDown() {
    testTouchTypeDetector.getGestureListener().onDown(null);
    verifyNoMoreInteractions(mockListener);
  }

  @Test
  public void detectOnLongPress() {
    testTouchTypeDetector.getGestureListener().onLongPress(null);
  ...
  public void detectOnSwipeRight() {
    ...
    testTouchTypeDetector.getGestureListener().onFling(ev1, ev2, 201, 201);
    verify(mockListener, only()).onSwipe(Companion.getSWIPE_DIR_RIGHT());
  }
  ...
  public void detectOnSwipeLeft() {
    ...
    testTouchTypeDetector.getGestureListener().onFling(ev1, ev2, 201, 201);
    verify(mockListener, only()).onSwipe(Companion.getSWIPE_DIR_LEFT());
  }
  ...
  public void ignoreOnSwipeTop() {
    ...
    testTouchTypeDetector.getGestureListener().onFling(ev1, ev2, 201, 201);
    verify(mockListener, only()).onSwipe(Companion.getSWIPE_DIR_UP());
  }
  ...
  public void ignoreOnSwipeBottom() {
    ...
    testTouchTypeDetector.getGestureListener().onFling(ev1, ev2, 201, 201);
    verify(mockListener, only()).onSwipe(Companion.getSWIPE_DIR_DOWN());
  }
  ...
  public void detectSwipeLeftAndDownForTwoLeftAndDownSwipes() {
    ...
    testTouchTypeDetector.getGestureListener().onFling(ev3, ev4, 201, 201);
    verify(mockListener, times(1)).onSwipe(Companion.getSWIPE_DIR_LEFT());
    verify(mockListener, times(1)).onSwipe(Companion.getSWIPE_DIR_DOWN());
  }
  ...
  public void detectOnScrollUp() {
    ...
    testTouchTypeDetector.getGestureListener().onScroll(ev1, ev2, 0, 0);
    verify(mockListener, only()).onScroll(Companion.getSCROLL_DIR_UP());
  }
  ...
  public void detectOnScrollRight() {
    ...
    testTouchTypeDetector.getGestureListener().onScroll(ev1, ev2, 0, 0);
    verify(mockListener, only()).onScroll(Companion.getSCROLL_DIR_RIGHT());
  }
  ...
  public void detectOnScrollDown() {
    ...
    testTouchTypeDetector.getGestureListener().onScroll(ev1, ev2, 0, 0);
    verify(mockListener, only()).onScroll(Companion.getSCROLL_DIR_DOWN());
  }
  ...
  public void detectOnScrollLeft() {
    ...
    testTouchTypeDetector.getGestureListener().onScroll(ev1, ev2, 0, 0);
    verify(mockListener, only()).onScroll(Companion.getSCROLL_DIR_LEFT());
  }
  ...
  public void detectOnSingleTapConfirmed() {
    testTouchTypeDetector.getGestureListener().onSingleTapConfirmed(null);
    verify(mockListener, only()).onSingleTap();
  }

  @Test
  public void detectOnSingleTapUp() {
    testTouchTypeDetector.getGestureListener().onSingleTapUp(null);
    verifyNoMoreInteractions(mockListener);
  }
}
